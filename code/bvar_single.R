...
posit_climate <- run_bvar_with_auto_lags(posit_climate, priors = priors, mh = mh)
posit_climate <- run_bvar_with_auto_lags(pos_climate, priors = priors, mh = mh)



#  Residuals should appear as a random sequence with no discernible pattern when plotted over time.

#png("residuals_net.png")
png("residuals_floods.png")
plot(residuals(pos_climate, type = "mean"), vars = c("floods"), col = "skyblue")
dev.off()
...
# Extract indices
log_net_migration_index <- which(posit_climate$variables == "log_net_migration")
...
posterior_samples <- posit_climate$beta[, flood_index, log_net_migration_index]
posterior_samples_1 <- posit_climate$beta[, flood_index_1, log_net_migration_index]
posterior_samples_2 <- posit_climate$beta[, flood_index_2, log_net_migration_index]
posterior_samples_3 <- posit_climate$beta[, flood_index_3, log_net_migration_index]
posterior_samples_4 <- posit_climate$beta[, flood_index_4, log_net_migration_index]
posterior_samples_5 <- posit_climate$beta[, flood_index_5, log_net_migration_index]

posterior_samples <- posit_climate$beta[, drought_index, log_net_migration_index]
posterior_samples_1 <- posit_climate$beta[, drought_index_1, log_net_migration_index]
posterior_samples_2 <- posit_climate$beta[, drought_index_2, log_net_migration_index]
posterior_samples_3 <- posit_climate$beta[, drought_index_3, log_net_migration_index]
posterior_samples_4 <- posit_climate$beta[, drought_index_4, log_net_migration_index]
posterior_samples_5 <- posit_climate$beta[, drought_index_5, log_net_migration_index]

posterior_samples <- posit_climate$beta[, tc_index, log_net_migration_index]
posterior_samples_1 <- posit_climate$beta[, tc_index_1, log_net_migration_index]
posterior_samples_2 <- posit_climate$beta[, tc_index_2, log_net_migration_index]
posterior_samples_3 <- posit_climate$beta[, tc_index_3, log_net_migration_index]
posterior_samples_4 <- posit_climate$beta[, tc_index_4, log_net_migration_index]
posterior_samples_5 <- posit_climate$beta[, tc_index_5, log_net_migration_index]
...
# Use labels a-f: a = flood_neg, b = flood_pos, ..., f = tc_pos
