...
tc_index <- which(compound_tc_pos_LI$variables == "cyc_share_pop")
tc_index_01 <- which(compound_tc_pos_LI$variables == "tc_0_1")
tc_index_012 <- which(compound_tc_pos_LI$variables == "tc_0_1_2")
tc_index_0123 <- which(compound_tc_pos_LI$variables == "tc_0_1_2_3") 


log_net_migration_index<- which(compound_tc_pos_LI$variables == "log_net_migration")
...
posterior_samples_1 <- compound_tc_pos_LI$beta[, tc_index, log_net_migration_index]
posterior_samples_2 <- compound_tc_pos_LI$beta[, tc_index_01, log_net_migration_index]
posterior_samples_3 <- compound_tc_pos_LI$beta[, tc_index_012, log_net_migration_index]
posterior_samples_4 <- compound_tc_pos_LI$beta[, tc_index_0123, log_net_migration_index]
...
flood_index <- which(compound_flood_pos_LI$variables == "fld_share_pop")
flood_index_01 <- which(compound_flood_pos_LI$variables == "flood_0_1")
flood_index_012 <- which(compound_flood_pos_LI$variables == "flood_0_1_2")
flood_index_0123 <- which(compound_flood_pos_LI$variables == "flood_0_1_2_3") 

log_net_migration_index<- which(compound_flood_pos_LI$variables == "log_net_migration")

# Extracting the posterior samples for this coefficient
# Assuming it's the first response variable (index 1 in the third dimension if it's multidimensional)
posterior_samples_1 <- compound_flood_pos_LI$beta[, flood_index, log_net_migration_index]
posterior_samples_2 <- compound_flood_pos_LI$beta[, flood_index_01, log_net_migration_index]
posterior_samples_3 <- compound_flood_pos_LI$beta[, flood_index_012, log_net_migration_index]
posterior_samples_4 <- compound_flood_pos_LI$beta[, flood_index_0123, log_net_migration_index]
...
drought_index_1 <- which(compound_drought_pos_LI$variables == "drt_share_pop")
drought_index_12 <- which(compound_drought_pos_LI$variables == "drought_0_1")
drought_index_123 <- which(compound_drought_pos_LI$variables == "drought_0_1_2")
drought_index_1234 <- which(compound_drought_pos_LI$variables == "drought_0_1_2_3") 

log_net_migration_index<- which(compound_drought_pos_LI$variables == "log_net_migration")


# Extracting the posterior samples for this coefficient
# Assuming it's the first response variable (index 1 in the third dimension if it's multidimensional)
posterior_samples_1 <- compound_drought_pos_LI$beta[, drought_index_1, log_net_migration_index]
posterior_samples_2 <- compound_drought_pos_LI$beta[, drought_index_12, log_net_migration_index]
posterior_samples_3 <- compound_drought_pos_LI$beta[, drought_index_123, log_net_migration_index]
posterior_samples_4 <- compound_drought_pos_LI$beta[, drought_index_1234, log_net_migration_index]
