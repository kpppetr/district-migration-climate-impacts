...
# Extract indices
log_net_migration_index <- which(pos_LI$variables == "log_net_migration")
...
posterior_samples <- pos_LI$beta[, flood_index, log_net_migration_index]
posterior_samples_1 <- pos_LI$beta[, flood_index_1, log_net_migration_index]
posterior_samples_2 <- pos_LI$beta[, flood_index_2, log_net_migration_index]
posterior_samples_3 <- pos_LI$beta[, flood_index_3, log_net_migration_index]
posterior_samples_4 <- pos_LI$beta[, flood_index_4, log_net_migration_index]
posterior_samples_5 <- pos_LI$beta[, flood_index_5, log_net_migration_index]
